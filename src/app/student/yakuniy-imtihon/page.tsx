...
export default function YakuniyImtihonPage() {
  const { t } = useLanguage();
    ...
    return (
      ...
      >
        ...
        <div className="mt-6 space-y-3">
          <button type="button" disabled={loadingStart} onClick={() => startExam(20)}
          ...
          <button type="button" disabled={loadingStart} onClick={() => startExam(50)}
